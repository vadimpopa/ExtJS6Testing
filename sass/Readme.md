...
folder are mapped to the application's root namespace, 'FooApp'. This is set in
`"app.json"`:
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'FooApp' in the same way
as `"FooApp/sass/src"`.
